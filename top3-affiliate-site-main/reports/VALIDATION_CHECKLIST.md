...
| Image references | Pass | No `<img>`, `/images/`, `Product_picture` or CSS `url()` image references remain in active HTML/CSS/JS |
| Image rights | Pass | Every legacy local/remote image reference is recorded as removed or not relied upon |
